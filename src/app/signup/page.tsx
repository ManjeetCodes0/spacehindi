...
export default function SignUpPage() {
  const { user, loading, signUpWithEmail, loginWithGoogle, loginWithFacebook } = useAuth();
  const { lang } = useLang();
  ...
  async function handleSignUp(e: FormEvent) {
    ...
    try {
      ...
      // Set displayName on the Firebase user after creation
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/3 right-1/3 w-[500px] h-[500px] bg-violet-600/8 rounded-full blur-[140px]" />
        <div className="absolute bottom-1/3 left-1/3 w-[400px] h-[400px] bg-blue-600/6 rounded-full blur-[120px]" />
      </div>
